...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      toast('Login Successful!', { description: 'Welcome back.', type: 'success' });
      router.push('/dashboard');
    } catch (err: any) {
    ...
    <div className="min-h-screen relative flex items-center justify-center p-6 bg-zinc-50 dark:bg-zinc-950 transition-colors duration-300">
      ...
      >
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2.5 group select-none" id="login-brand">
          ...
          <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400 font-sans">
            Scale autonomous digital work instantly.
          </p>
        </div>

        <Card className="border border-zinc-200/80 dark:border-zinc-850 bg-white/85 dark:bg-zinc-900/65 backdrop-blur-md shadow-2xl" id="login-card">
          <CardHeader>
            <CardTitle className="text-xl sm:text-2xl font-extrabold tracking-tight">Access Platform</CardTitle>
            <CardDescription className="font-sans">Enter your credentials to manage your AI agents.</CardDescription>
          </CardHeader>
          ...
          <CardContent>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-center justify-end pt-1 select-none">
                  <Link 
                    ...
                    className="text-xs font-semibold text-brass-600 hover:text-brass-500 dark:text-brass-400 dark:hover:text-brass-300 transition-colors font-sans"
              ...
              <Button 
                ...
                id="login-submit-btn"
              >
                Sign In to NexCart AI <ArrowRight className="h-4 w-4 ml-1.5" />
              </Button>
            </form>
          </CardContent>
          ...
          <CardFooter className="flex-col gap-3">
            <p className="text-xs font-medium text-zinc-500 dark:text-zinc-400 font-sans">
              Don&apos;t have a NexCart AI account?{' '}
              <Link 
                href="/auth/signup" 
